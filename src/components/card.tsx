    ...
    return (
        <Link href={link}>
            <div className={'relative min-w-[200px] m-2 group cursor-pointer rounded-lg  shadow-md hover:shadow-lg transition-transform ' + cardSizeClasses}>
                ...
                {little ? null
                    :
                    <div id="cardDesc" className='z-10 md:-z-10 absolute w-full bottom-0 rounded-b-lg bg-slate-900 opacity-100 p-3 group-hover:translate-y-full group-hover:opacity-100 transition-all overflow-visible'>
