    ...
    <Layout>
      <Head>
        ...
        <main className="container mx-auto flex flex-col min-h-screen p-4">
          ...
          {user?.name != null ? <h2 className="w-full text-center text-2xl md:text-3xl text-text-dark">Welcome <span className='text-primary'>{user.name}</span></h2> : <h2 className=" w-full text-center text-2xl md:text-3xl text-text-dark">Welcome Guest</h2>}
